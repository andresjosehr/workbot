...
class TasksController extends Controller
{
    ...
    public function sendMessage($client, $data, $IDUser){
        ...
        try {
            $client->request('GET', 'https://api.telegram.org/bot1299600512:AAEGCf2ufchepoeUSwFFO-CDdRpTnUx9IKE/sendMessage?chat_id='.$IDUser.'&parse_mode=HTML&text='.$message);
        } catch (\Throwable $th) {
            return $th;
        }
    ...
    public function setConfig(Request $request)
    {
        ...
        $client->request('GET', 'https://api.telegram.org/bot1299600512:AAEGCf2ufchepoeUSwFFO-CDdRpTnUx9IKE/sendMessage?chat_id='.$user.'&parse_mode=HTML&text='.$message);
